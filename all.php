					...
					?>
						<div class="col-lg-7" style="width: 800px;">
							<div class="card-deck" style="width: 800px;">
								<div class="card p-2 border-secondary mb-2" style="width: 800px;">
									<img src="<?php echo $row['img1']; ?>" class="card-img-top" style="height: 500px;width: 500px;align-self: center">
